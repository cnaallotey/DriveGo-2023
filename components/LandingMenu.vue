<template>
  <div class="relative pt-5 px-4 overflow-hidden">
    <section >
      <div class="w-full h-full justify-between items-center inline-flex">
        <div class="justify-center items-center gap-2 flex">
          <div class="text-lime-600 text-2xl font-martelsans font-bold break-words cursor-pointer">
            logo
          </div>
        </div>
        <div class="justify-start items-center gap-[2.625rem] flex">
          <div class="text-slate-500 text-sm font-martelsans font-normal break-words cursor-pointer">
            Services
          </div>
          <div class="text-slate-500 text-sm font-martelsans font-normal break-words cursor-pointer">
